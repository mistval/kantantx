...
export interface IDatabaseAdapter {
  ...
  getUsersByRole: (role: Role, limit?: number) => Promise<ISensitiveUser[]>;
  ...
  updateDocumentSourceStrings: (userId: number, documentName: string, sourceStrings: Array<ISourceString>) => Promise<void>;
